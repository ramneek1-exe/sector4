...
const COMPOUND_SYSTEM = [
  ...
  "The first line of the user message is a grounded lede; build naturally from it rather than repeating it verbatim.",
  "This is a HISTORICAL pattern (the compound that has most often been dominant here in past runnings), NOT a telemetry prediction. Never present it as a forecast of this weekend.",
  "The `year` in the JSON is the weekend being asked about; the compound reflects runnings from BEFORE it, so never state it as that specific year's own observed result, even for a past race. Describe the circuit's general historical tendency, not a named year's outcome.",
