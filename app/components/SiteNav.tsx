...
export const NAV_H = 56; // px (h-14) — the layout pads the body by this so content clears it
...
const linkClass =
  "relative cta-grow font-pixel text-xl leading-none tracking-wide transition-colors duration-200 motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/60";
...
export function SiteNav() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-30 flex h-14 items-center justify-between bg-bg/95 px-6 backdrop-blur-sm">
      <Link
        href="/"
      ...
      <nav className="flex items-center gap-6">
        ...
        <Link href="/weekend" className={`${linkClass} text-ink/80 hover:text-ink`}>
          Upcoming weekend
        </Link>
      </nav>
    </header>
